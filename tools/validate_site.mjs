...
const files = ['index.html', 'style.css', 'app.js', 'planner.js', 'search.js', 'recipe-view.js', 'navigation.js', 'build-list.js', 'material-export.js', 'minecraft-export.js', 'favorites.js', 'catalog.json', 'recipe-layouts.json', 'downloads/techit-build-list-0.2.2.jar'];
