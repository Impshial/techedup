...
const files = ['index.html', 'style.css', 'app.js', 'ask-me.js', 'ask-me-ui.js', 'planner.js', 'search.js', 'recipe-view.js', 'navigation.js', 'build-list.js', 'material-export.js', 'minecraft-export.js', 'favorites.js', 'catalog.json', 'recipe-layouts.json', 'downloads/teched-up-build-list-0.4.0.jar'];
